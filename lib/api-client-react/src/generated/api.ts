 ...
 */
export const listFiles = async (id: number, options?: RequestInit): Promise<ProjectFile[]> => {
...
export const getGenerateCodeUrl = (id: number,) => {
...
export const generateCode = async (id: number,
  ...
  return customFetch<GenerateResult>(getGenerateCodeUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGenerateCodeMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateCode>>, TError,{id: number;data: BodyType<GenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateCode>>, TError,{id: number;data: BodyType<GenerateInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateCode>>, {id: number;data: BodyType<GenerateInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  generateCode(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateCodeMutationError = ErrorType<void>

    /**
 * @summary Send a prompt to Claude, generate code, deploy to E2B sandbox, return preview URL
 */
export const useGenerateCode = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateCode>>, TError,{id: number;data: BodyType<GenerateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getRefreshSandboxUrl = (id: number,) => {




  return `/api/projects/${id}/sandbox/refresh`
}

/**
 * @summary Restart the sandbox for a project and get fresh preview URL
 */
export const refreshSandbox = async (id: number, options?: RequestInit): Promise<SandboxStatus> => {

  return customFetch<SandboxStatus>(getRefreshSandboxUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getRefreshSandboxMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof refreshSandbox>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof refreshSandbox>>, TError,{id: number}, TContext> => {

const mutationKey = ['refreshSandbox'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof refreshSandbox>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  refreshSandbox(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RefreshSandboxMutationResult = NonNullable<Awaited<ReturnType<typeof refreshSandbox>>>

    export type RefreshSandboxMutationError = ErrorType<void>

    /**
 * @summary Restart the sandbox for a project and get fresh preview URL
 */
export const useRefreshSandbox = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof refreshSandbox>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof refreshSandbox>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getRefreshSandboxMutationOptions(options));
    }
